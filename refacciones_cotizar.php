<!– PARA EJEMPLO DASC — >
<?php
$id_refaccion_seleccionada = $_GET['producto_id'];
$nombre_refaccion_seleccionada = $_GET['producto_nombre'];
?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="jumbotron">
                ...
                <form role="form" id="login-form" 
                    ...
                    <div class="form-group">
                        <label>ID del producto seleccionada (<?php echo $nombre_refaccion_seleccionada ?>)</label>
